...
/**
 * Abstract base class for {@link net.pkhapps.fenix.core.control.Crud} implementations that work with
 * {@link net.pkhapps.fenix.core.entity.AbstractFireDepartmentSpecificEntity} instances.
 */
public abstract class AbstractFireDepartmentSpecificCrud<E extends AbstractFireDepartmentSpecificEntity, R extends FireDepartmentSpecificEntityRepository<E>> extends AbstractCrud<E, R> {

    private final SessionInfo sessionInfo;

    protected AbstractFireDepartmentSpecificCrud(Validator validator, R repository, ApplicationContext applicationContext, SessionInfo sessionInfo) {
